class Game {
        ...
        for(var plr in allPlayers){
           if(allPlayer[plr].place === 1){
           text("first "+allPlayers[plr].name,0,85)
           }else if(allPlayers[plr].place === 2 ){
             text("second "+allPlayers[plr].name,displayWidth/4,displayHeight/9+76)
           }
           else if (allPlayer[plr].place === 3){
            text("third "+allPlayers[plr].name,displayWidth/4,displayHeight/10+79);
        }else{
